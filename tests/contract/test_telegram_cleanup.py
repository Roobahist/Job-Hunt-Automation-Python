...
@respx.mock
def test_terminal_failure_deletes_processing_message() -> None:
...
@respx.mock
def test_terminal_failure_before_notification_init_creates_no_message() -> None:
