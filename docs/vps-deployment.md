...
5. Run `bash scripts/deploy-vps.sh` for normal deployments. It performs a fast-forward-only pull, builds the images, runs live configuration validation, starts the stack, and verifies API and Redis health.
